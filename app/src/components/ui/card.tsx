...
>(({ className, hover = false, glass = false, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      hover && 'transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-0.5 hover:border-white/80',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn('font-display text-xl font-semibold leading-none tracking-tight text-gray-900', className)}
    {...props}
  />
))
